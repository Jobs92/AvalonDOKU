...
Der Typ \textit{Event} besteht aus einem \textit{Text}, einem \textit{Type} und einem \textit{Value}. Der Inhalt dieser Attribute lässt sich an folgendem Beispiel erkennen:\\
